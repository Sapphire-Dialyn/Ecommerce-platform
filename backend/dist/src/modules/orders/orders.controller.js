...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Return list of my orders.' }),
...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: 'Get all orders (Admin/Manager filter)' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Return list of orders.' }),
    (0, common_1.Get)(),
    __param(0, (0, common_1.Request)()),
    __metadata("design:type", Function),
...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: 'Update payment status (Called by Frontend/IPN)' }),
