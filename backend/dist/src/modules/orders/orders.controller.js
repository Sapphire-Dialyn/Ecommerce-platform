...
let OrdersController = class OrdersController {
    ...
    findAll(req) {
        var _a, _b;
        return this.ordersService.findAll((_a = req.user) === null || _a === void 0 ? void 0 : _a.id, (_b = req.user) === null || _b === void 0 ? void 0 : _b.role);
    }
    findOne(id, req) {
        var _a, _b;
        return this.ordersService.findOne(id, (_a = req.user) === null || _a === void 0 ? void 0 : _a.id, (_b = req.user) === null || _b === void 0 ? void 0 : _b.role);
    }
